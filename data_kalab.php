...
<body id="page-top">
<?php
$sql5=mysqli_query($koneksi, "select * from user where level='admin' limit 1");
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?=$data5['nama'];?></span>
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">DATA KALAB</h1>
          ...
          <div class="card shadow mb-4">
            <div class="card-body">
              ...
              <?php 
                $sql3=mysqli_query($koneksi, "select * from user where level='kalab'");
                while ($data3=mysqli_fetch_array($sql3)) {
                        ?>
                  <li class="nav-item">
                  <a class="nav-link active" href="data_kalab.php?id_user=<?php echo $data3['id_user']; ?>"><?=$data3['username'];?></a>
                  </li>
              <?php }?>
              </ul>
              <br>
              ...
              ?>
              <div>Nama Kepala Laboratorium: <?=$data3['nama'];?></div>
              <br>
              <div class="table-responsive">
              <a href="tambah_lab.php?id_user=<?php echo $data3['id_user']; ?>"><i class="fas fa-plus"></i>&nbsp;&nbsp;Tambah Laboratorium</a>
              <div class="dropdown-divider"></div>
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  $sql=mysqli_query($koneksi, "select * from laboratorium where id_user=$id_user");
                  ...
                  ?>
                    <tr>
                      ...
                      <td><?php echo $data['nama_kalab']; ?></td>
                      <td><?php echo $data['nama_plp']; ?></td>
                      <td><?php 
                      $angka2 = $data['total_anggaran'];
                      echo rupiah2($angka2);?></td>
                      <td><a href="edit_lab.php?id_lab=<?php echo $data['id_lab']; ?>">
                          <button class="btn btn-primary"><i class='fas fa-edit'></i></button>
                          </a>
                          <a href="sistem_hapus_lab.php?id_lab=<?php echo $data['id_lab']; ?>">
