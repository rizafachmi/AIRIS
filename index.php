...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <h1 class="logo"><a href="">ASET AE</a></h1>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 pt-2 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
          <h1>Aplikasi Web Aset Alat di Jurusan AE</h1>
          <ul>
            <li><i class="ri-check-line"></i> Order barang maupun alat</li>
          </ul>
          <div class="mt-3">
          <?php
          ...
          ?>
            <a href="login_lab.php" class="btn-get-quote">Laboratorium</a>
          </div>
        </div>
