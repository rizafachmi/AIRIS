    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- DataTales Example -->
          <form class="form-horizontal" action="sistem_tambah_mhs.php" method="post">
            <div class="form-group">
              <label class="control-label col-sm-4" for="nim">Nomor Induk Mahasiswa:</label>
              <div class="col-sm-10">
                <input type="number"  min="0" class="form-control" name="nim" id="nim" placeholder="Nomor Induk Mahasiswa" required>
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              <label class="control-label col-sm-2" for="no_koin">Nomor Koin:</label>
              <div class="col-sm-10">
                <input type="text" class="form-control" id="no_koin" placeholder="Nomor Koin" name="no_koin" required>
              </div>
            </div>
            <div class="form-group">
