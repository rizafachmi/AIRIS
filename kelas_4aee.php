      ...
      <li class="nav-item active">
        ...
        <div id="collapsePages" class="collapse show" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item active" href="kelas_4aee.php">4AEE</a>
          </div>
        </div>
      </li>
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">4AEE</h6>
            </div>
            <div class="card-body">
              ...
              <div class="dropdown-divider"></div>
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                  <?php
                  $sql=mysqli_query($koneksi, "select * from mahasiswa where kelas='4AEE'");
                  ...
                  ?>
                    <tr>
                      ...
                      <td><a href="edit_mhs.php?nim=<?php echo $data['nim']; ?>">
                          ...
                          <a href="sistem_hapus_mhs.php?nim=<?php echo $data['nim']; ?>">
