      ...
      <li class="nav-item active">
        ...
        <div id="collapsePages" class="collapse show" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            ?>
            <a class="collapse-item active" href="pinjam_laboratorium_lab.php?id_lab=<?php echo $data3['id_lab']; ?>&nama_alat=<?php echo $data3['nama_alat']; ?>">Data Peminjaman</a>
          </div>
        </div>
      </li>
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  ?>
                    <tr>
                      ...
                      ?>
                        <td><a href="pinjam.php?no_alat=<?php echo $data['no_alat']; ?>">
                      ...
                      <td><a href="history_lab.php?no_alat=<?php echo $data['no_alat']; ?>">
