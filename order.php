    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">ORDER BARANG ASET</h1>
          
          <?php 
          if(isset($_GET['berat_alat'])){
            if($_GET['berat_alat'] == "kosong"){
              echo '<script>alert("Data tidak boleh kosong!")</script>';
            }
          }
          if(isset($_GET['jumlah_pesan'])){
            if($_GET['jumlah_pesan'] == "kosong"){
              echo '<script>alert("Data tidak boleh kosong!")</script>';
            }
          }
          ?>
          ...
          <!-- DataTales Example -->
          <form class="form-horizontal" action="sistem_order.php" method="post">
            <div class="form-group">
              <label class="control-label col-sm-2" for="nama_alat">Jenis Alat:</label>
              <div class="col-sm-10">
              <select onChange="getdistrict(this.value);" class="form-control" id="jenis" name="id_jenis"> 
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
              <select class="form-control" id="kode_alat" name="kode_alat">
                <option value="">Pilih Nama Alat</option>
                </select>
              </div>
            </div>
            <div class="form-group">
              <label class="control-label col-sm-2" for="berat_alat">Berat Alat (gram):</label>
              <div class="col-sm-10">
                <input type="number"  min="0" oninput="validity.valid||(value='');"  class="form-control" id="berat_alat" placeholder="Berat Alat" name="berat_alat" required>
              </div>
            </div>
            <div class="form-group">
              <label class="control-label col-sm-2" for="jumlah_pesan">Jumlah Pesan:</label>
              <div class="col-sm-10">
                <input type="number"  min="0" oninput="validity.valid||(value='');"  class="form-control" id="jumlah_pesan" placeholder="Jumlah Pesan" name="jumlah_pesan" required>
              </div>
            </div>
            <div class="form-group">
              <label class="control-label col-sm-2" for="lokasi_alat">Lokasi Alat:</label>
              <div  class="col-sm-10">
                <input type="text" class="form-control" id="lokasi_alat" name="lokasi_alat" value="<?= $_SESSION['nama_lab']?>">
              </div>
            </div>
            <div class="form-group">
