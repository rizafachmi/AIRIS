      ...
      <li class="nav-item active">
        ...
        <div id="collapsePages" class="collapse show" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item active" href="pinjam_laboratorium_lab.php">Data Peminjaman</a>
          </div>
        </div>
      </li>
            ...
            <div class="card-body">
              <ul class="nav nav-tabs">
                ...
                <a class="nav-link active dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false"><?=$data3['jenis_alat'];?></a>
                  <div class="dropdown-menu">
                    ...
                    while ($data3=mysqli_fetch_array($sql)) {
                    ?>
                    <a class="dropdown-item" href="pinjam_laboratorium_lab.php?id_lab=<?php echo $data3['id_lab']; ?>&nama_alat=<?php echo $data3['nama_alat']; ?>"><?=$data3['nama_alat'];?></a>
                    <?php } ?>
                  </div>
                </li>
                <?php } ?>
                <li class="nav-item">
                  <a class="nav-link" href="pinjam_segera.php">Segera dikembalikan</a>
                </li>
              </ul>
              <br>
              <div class="table-responsive">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  $tglskrg = date('Y-m-d');
                  $sql=mysqli_query($koneksi, "SELECT * FROM alat INNER join peminjaman inner join mahasiswa WHERE alat.no_alat=peminjaman.no_alat and peminjaman.id_lab='$id_lab' and peminjaman.nim=mahasiswa.nim and peminjaman.tgl_seharusnya='$tglskrg' and peminjaman.tgl_selesai='0000-00-00'");     
